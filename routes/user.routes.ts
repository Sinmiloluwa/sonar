...
import { getProfile, getUserById, updateEmail, updateLocation, getNearbyUsers } from "../controllers/user.js";
...
router.patch('/email', auth, validate(updateEmailSchema as any), updateEmail);
